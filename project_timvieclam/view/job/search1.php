...
<div class="promo-block">
            <div class="container">
                ...
                <form method="POST" action='?controller=job&action=jobSearch' class="col-lg-12" id="searchForm">
                     <input class="form-control" name="txt_name_search" type="text" placeholder="Search" style="border-radius: 10px;width: 70%;margin-left: 175px;" ><br>
                    <p><select style="height: 40px;width: 350px;border-radius: 5px" name="txt_nganh">
                       ...
                       <?php 
                         ...
                         ?>
                        <option value="<?php echo $value['id_nganh']; ?>" style='color:black'><?php echo $value['ten_nganh']; ?></option>
                        <?php
                            }
                         ?>
                    ...
                    <span>
                        <select style="height: 41px;width: 350px;border-radius: 5px" name="txt_tp">
                            <option value="" style="color: black;" >Thành Phố</option>
                           
                            <?php 
                                foreach ($data['thanhpho'] as $key => $value) {
                            ?>
                            <option value="<?php echo $value['id_thanhpho']; ?>" style="color:black"><?php echo $value['ten_tp']; ?></option>
                            <?php
                                }
                             ?>
        ...
        <div id="products">
            <div class="container content-lg">
                ...
                <div class="row">
                    ...
                    <!-- Latest Products -->
                    <?php 
                        foreach ($data['baituyen'] as $key => $value) {
                     ?>
                  
                   <div class="col-sm-2 sm-margin-b-50 " data-wow-duration="1.5s" data-wow-delay="0.4s">
                        <div class="margin-b-20">
                            <a href="#"><img class="img-responsive button bubble-float-bottom" style="margin-left: -12px" src="asset/img/970x647/02.jpg" ></a>
                        </div>
                        <h4 style="font-size: 15px"><a href="?controller=job&action=detail&id=<?php echo $value['id_baituyen'] ?>"><?php echo $value['tieude']; ?></a></h4>
                        <p>Hình thức: <?php echo $value['hinhthuc']; ?></p>
        ...
        <!-- phần việc làm mới nhất -->
         <div id="products">
            <div class="container content-lg">
                <div class="row text-center margin-b-40">
                    <div class="col-sm-6 col-sm-offset-3">
                        <h2 class="" data-wow-duration="1s" data-wow-delay="0.4s" data-wow-iteration="1">Việc Làm mới nhất <span style="color: red;font-size: 20px;">*</span></h2>
                ...
                <div class="row">
                    <!-- Latest Products -->
                    <div class="col-sm-2 sm-margin-b-50 " data-wow-duration="0.2s" >
                        <div class="margin-b-20">
                    ...
                    <!-- Latest Products -->
                    <div class="col-sm-2 sm-margin-b-50 " data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="margin-b-20">
                ...
                <div class="row">
                    ...
                    <!-- Latest Products -->
                    <div class="col-sm-2 sm-margin-b-50 " data-wow-duration="0.2s" data-wow-delay="0.4s">
                        <div class="margin-b-20">
                            <a href="#"><img class="img-responsive button bubble-float-bottom" style="margin-left: -12px" src="asset/img/970x647/03.jpg" ></a>
                        </div>
                        <h4 style="font-size: 15px" ><a href="#">Quản lý nhà hàng</a></h4>
                    ...
                    <!-- Latest Products -->
                    <div class="col-sm-2 sm-margin-b-50 " data-wow-duration="0.2s" data-wow-delay="0.3s">
                        <div class="margin-b-20">
                            <a href="#"><img class="img-responsive button bubble-float-bottom" style="margin-left: -12px" src="asset/img/970x647/03.jpg" ></a>
                        </div>
                        <h4 style="font-size: 15px" ><a href="#">Quản lý nhà hàng</a></h4>
        ...
        <div id="service">
            <div class="bg-color-sky-light" data-auto-height="true">
                <div class="content-lg container">
                    <h2 style="text-align: center;" class="">Cẩm nang</h2>
